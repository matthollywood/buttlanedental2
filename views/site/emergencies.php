...
<div class="site-about">
    <div class="body-content">
        ...
        <h2>All Dental Emergencies</h2>
        </div>
<div class="row">
            <div class="col-lg-4">
                <h4>During practice hours:</h4>
...
Also the following dental clinics are open every Saturday, Sunday and Bank Holidays:<br>

<div class="row">
            <div class="col-lg-4">
                <div class="dent-title">
                <h4>Nantwich Health Centre</h4>
                </div>
                <p>Beam Street, Nantwich, CW5 5NX <br>
...
Phone: 01270 611044 <br></p>
            ...
            <div class="col-lg-4">
                <div class="dent-title">
                <h4>Macclesfield Dental Access Centre</h4>
                </div>
                <p>89 Churchill Way, SK11 6AY <br>
...
Phone: 01625 669039 <br></p>
                ...
                <p>Willington Hill, Northwich, CW8 1AN<br>

Open: 10.00am - 12.00 noon<br>
...
<div>
For Dental Advice Only<br>
<ul>
<li>phone The NHS 111 Service. This service is available every day, 24 hours a day. <br></li>
<li>use the NHS Direct  website at www.nhsdirect.nhs.uk which is helpful for more general dental information.</li>
</ul>
</div>
</div>
    </div>

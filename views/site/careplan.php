...
<div class="card">
            <img src="images/family.jpg" class = "pc-image" style="float: right; width: 45%; padding: 4px 4px 4px 4px">
...
Our modern health-promoting approach with continuing care means:
    <ul>
        ...
        <li>More choice</li>
        <li>Reduced costs</li>
        <li>Helping to keep your own teeth for life</li>
    </ul>
</div>
</div>
<div class="col-lg-6 col-xs-12">
<div class="card">
    ...
    <ul>
        <li>A convenient payment scheme for routine treatment</li>
        <li>Greater choice of treatment and materials</li>
        <li>More time to help prevent decay and gum disease</li>
        <li>A fair and equitable system where everybody pays the same</li>
        <li>Substantial discounts on additional treatments</li>
        <li>Worldwide Trauma and Emergency Callout Insurance</li>
        <li>Redundancy Protection</li>
    </ul>
</div>
</div>
<div class="row">
